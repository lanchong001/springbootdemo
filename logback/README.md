### logboak: Spring Boot 自带日志库
---
1. spring-boot-starter-web 或者 spring-boot-starter 中默认包含了 logback-classic 库
2. 添加logback-spring.xml配置文件
```
<?xml version="1.0" encoding="UTF-8"?>
<configuration>
    <property name="logger.path" value="E:/logs"/>
    <!-- 彩色日志 -->
    <!-- 彩色日志依赖的渲染类 -->
...
```
3. 在需要记录日志的类中创建 Logger 对应，并调用 logger.info, logger.error,logger.debug, dogger.warn 方法记录日志
```
@RestController
